...
<?php else: ?>
<div class="row">
<div id="tags-form" class="col-md-4">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title"><?php _e('New Tag','mywords'); ?></h3>
        </div>
...
<div id="tags-list" class="col-md-8">
	...
	<div class="cu-bulk-actions">
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <h3 class="panel-title"><?php _e('Existing tags', 'mywords'); ?></h3>
            </div>
